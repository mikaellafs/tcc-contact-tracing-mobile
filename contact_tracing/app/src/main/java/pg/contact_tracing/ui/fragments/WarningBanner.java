 ...
 * Use the {@link WarningBanner#newInstance} factory method to
...
public class WarningBanner extends Fragment {
    ...
    public static WarningBanner newInstance(String param1, String param2) {
        WarningBanner fragment = new WarningBanner();
